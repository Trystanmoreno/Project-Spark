local lever2Activated = Instance.new("BoolValue")
lever2Activated.Name = "Lever2Activated"
lever2Activated.Value = false
lever2Activated.Parent = game.Workspace
